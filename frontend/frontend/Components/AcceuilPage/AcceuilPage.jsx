...
const backgroundImage = require('C:/Users/HP/Desktop/cuppfa/frontend/frontend/assets/back1.jpg'); // Chemin vers votre image d'arrière-plan
    ...
    <ImageBackground source={backgroundImage} style={styles.backgroundImage}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.menuContainer}>
          <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('CalendarPagey')}>
