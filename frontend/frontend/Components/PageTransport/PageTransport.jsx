...
const backgroundImage = require('C:/Users/HP/Desktop/cuppfa/frontend/frontend/assets/Transport/back.jpg')
...
const PageRecommandations = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.welcomeText}>Veuillez  choisir une ville :</Text>
